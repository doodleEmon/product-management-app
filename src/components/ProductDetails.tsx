...
export function ProductDetails() {
    ...
    const { product, currentPage, limit, slugLoading } = useSelector((state: RootState) => state.product);
    ...
    useEffect(() => {
        ...
        // Optional: clear previous product instantly to avoid flash
    ...
    const onConfirmDelete = async () => {
        ...
        const result = await dispatch(deleteProduct({ id: toDelete.id, token: authToken as string }));
